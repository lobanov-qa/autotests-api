...
print(response.json())
#print(response.headers)# Ответ с созданной записью
...
# response = httpx.get("https://jsonplaceholder.typicode.com/todos?userId=1") # другой вариант
...
# Отправка файлов
with open("example.txt", "rb") as file_handle:
    files = {"file": ("example.txt", file_handle)}
